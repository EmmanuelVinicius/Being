...
const itemsSchema = require('../database/strategies/mongodb/schemas/itemsSchema')
...
describe('Mongodb Strategy tests suit', function () {
    this.timeout(Infinity)
    this.beforeAll(async () => {
        const connection = Mongodb.connect();
        context = new Context(new Mongodb(connection, itemsSchema));
